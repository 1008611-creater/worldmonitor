 ...
 * Summarization stays via the existing edge function and configured provider chain.
...
// Summarization (client-side with generic/Ollama/Groq/OpenRouter/Browser T5 fallback)
